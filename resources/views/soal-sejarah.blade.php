...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/soal-metik.css') }}">
    <script type="text/javascript" src="{{ asset('js/soal-sejarah.js') }}" defer></script>
</head>
<body>
    <div class="quiz-container" id="quiz">
        <div class="quiz-header">
            <h2 id="question">Quiz Biologi</h2>
            <ul>
